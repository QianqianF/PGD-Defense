...
class Intermediate(nn.Module):
    ...
    def __init__(self, base_classifier: torch.nn.Module, num_steps, epsilon):
        """
    ...
    def forward(self, x):
        ...
        high_confidence_image = attacker.attack(self.base_classifier, x, None, entropy_attack=True)
